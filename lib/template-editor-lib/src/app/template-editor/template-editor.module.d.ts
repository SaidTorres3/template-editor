...
import * as i1 from "./template-editor.component";
import * as i2 from "../pipes/isObject.pipe";
import * as i3 from "../components/workspace/data/tree-node/tree-node.component";
import * as i4 from "../pipes/has-these-props.pipe";
import * as i5 from "../pipes/does-string-represent-primitive.pipe";
import * as i6 from "../pipes/enters-to-br.pipe";
import * as i7 from "../components/workspace/viewable-phrase/viewable-phrase.component";
import * as i8 from "../pipes/is-array.pipe";
import * as i9 from "../directives/focus.directive";
import * as i10 from "../components/workspace/editable-phrase/editable-phrase.component";
import * as i11 from "../components/workspace/data/data.component";
import * as i12 from "../components/header/header.component";
import * as i13 from "../components/workspace/workspace.component";
import * as i14 from "../components/footer/footer.component";
import * as i15 from "../directives/selection-range.directive";
