...
const docxToEditableObjects = (docxFile) => __awaiter(void 0, void 0, void 0, function* () {
...
const transformEditablePhrasesToString = (phrases) => {
    phrases = phrases.map(a => (Object.assign({}, a)));
...
const docxToString = (docxFile) => __awaiter(void 0, void 0, void 0, function* () {
    return new Promise((resolve, reject) => {
        // unzip the file
        const zip = new JSZip();
        zip.loadAsync(docxFile).then(function (zip) {
...
const editableObjectToDocx = (opts) => __awaiter(void 0, void 0, void 0, function* () {
    return new Promise((resolve, reject) => {
        // unzip the file
...
class TreeNodeComponent {
    ...
    isFoundedItem(titleValue, pathValue) {
        ...
        titleValue = (_b = (_a = titleValue === null || titleValue === void 0 ? void 0 : titleValue.trim()) === null || _a === void 0 ? void 0 : _a.toLowerCase()) === null || _b === void 0 ? void 0 : _b.normalize("NFD").replace(/[\u0300-\u036f]/g, ""); // replace accent characters to non accent characters
        pathValue = (_d = (_c = pathValue === null || pathValue === void 0 ? void 0 : pathValue.trim()) === null || _c === void 0 ? void 0 : _c.toLowerCase()) === null || _d === void 0 ? void 0 : _d.normalize("NFD").replace(/[\u0300-\u036f]/g, "").replace(/\./g, " ");
        const search = (_g = (_f = (_e = this.workspace.searchData) === null || _e === void 0 ? void 0 : _e.trim()) === null || _f === void 0 ? void 0 : _f.toLowerCase()) === null || _g === void 0 ? void 0 : _g.normalize("NFD").replace(/[\u0300-\u036f]/g, "").replace(/\./g, " ");
    ...
    replaceArraySymbolToEachSentence(text) {
        ...
        for (let [index, sentence] of dividedText.entries()) {
            ...
            if (sentence.includes("∀") &&
                !((_a = dividedText[index - 1]) === null || _a === void 0 ? void 0 : _a.includes("∀")) &&
                !((_b = dividedText[index + 1]) === null || _b === void 0 ? void 0 : _b.includes("∀"))) {
                if (!posibleResult) {
            ...
            else if (match && !((_c = dividedText[index - 1]) === null || _c === void 0 ? void 0 : _c.includes("∀"))) {
                console.log(match[1]);
...
class EditablePhraseComponent {
    ...
    pasteContentWithoutStylesAndEnters(e, index) {
        ...
        let text = (_a = e.clipboardData.getData("text/plain")) === null || _a === void 0 ? void 0 : _a.replace(/\n/g, " ");
...
const stringToIsVariableAndExist = (text, data) => {
    ...
    text.split(isVariableRegex).forEach((part) => {
        var _a;
        const isThereAMatchWithRegex = (_a = part.match(isVariableRegex)) === null || _a === void 0 ? void 0 : _a.length;
...
class AppComponent {
    constructor() {
        ...
        this.undo = () => {
            if (this.workspace.historyIndex > 0) {
                const editablePhrasesFromLastestElementInHistory = this.history[this.workspace.historyIndex].editablePhrases.map((a) => (Object.assign({}, a)));
                this.workspace.historyIndex--;
                this.workspace = Object.assign(Object.assign({}, this.workspace), { lastModifiedEditablePhraseIndex: this.history[this.workspace.historyIndex].lastModifiedEditablePhraseIndex, lastSelection: this.history[this.workspace.historyIndex].selection });
                editablePhrasesFromLastestElementInHistory.map((editablePhrase, index) => {
                    ...
                    if (editablePhrase.value !== editablePhraseFromHistory.value) {
                        this.editablePhrases[index] = Object.assign({}, this.history[this.workspace.historyIndex].editablePhrases[index]);
                    }
                });
        ...
        this.redo = () => {
            if (this.workspace.historyIndex + 1 <= this.history.length - 1) {
                ...
                editablePhrasesFromLastestElementInHistory.map((editablePhrase, index) => {
                    const editablePhraseFromHistory = this.history[this.workspace.historyIndex].editablePhrases[index];
                    if (editablePhrase.value !== editablePhraseFromHistory.value) {
                        this.editablePhrases[index] = Object.assign({}, editablePhraseFromHistory);
                    }
                });
                this.updateViewablePhrasesValue();
            }
    ...
    setTemplateFromFile(inputFile) {
        ...
        reader.onloadend = (e) => {
            ...
            this.docxFile = Object.assign(Object.assign({}, this.docxFile), { name: inputFile.name, lastModifiedDate: inputFile.lastModified, content: data });
    ...
    setPhrases(editableObjects) {
        this.editablePhrases = editableObjects.map((a) => (Object.assign({}, a)));
        this.history = [
            {
                editablePhrases: editableObjects.map((a) => (Object.assign({}, a))),
                lastModifiedEditablePhraseIndex: 0,
                selection: undefined,
            },
        ];
    ...
    updateEditablePhrase(inputEvent, editablePhraseIndex) {
        ...
        const modifiedPhrasesFromHistory = this.history[this.history.length - 1].editablePhrases.map((a) => (Object.assign({}, a)));
        modifiedPhrasesFromHistory[editablePhraseIndex].value =
            phraseElement.innerText;
        this.history.push({
            editablePhrases: [...modifiedPhrasesFromHistory].map((a) => (Object.assign({}, a))),
            lastModifiedEditablePhraseIndex: editablePhraseIndex,
            selection: selectionRange,
        });
        this.workspace = Object.assign(Object.assign({}, this.workspace), { lastModifiedEditablePhraseIndex: editablePhraseIndex, lastSelection: selectionRange, historyIndex: this.history.length - 1 });
        this.updateViewablePhrasesValue();
    }
    setMode(mode) {
    ...
    updateEditablePhrasesValue() {
        ...
        this.editablePhrases = this.history[this.workspace.historyIndex].editablePhrases.map((a) => (Object.assign({}, a)));
...
//# sourceMappingURL=template-editor.mjs.map
